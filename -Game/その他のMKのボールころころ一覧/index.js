...
const li_OtherMKBC=[
    createGames("Remix S9-4ボールころころ10　Hardmode2　★10" , gameURL("235785271","","")+gameDesMKRS(`2400 (400×6)`,`なし (S9-4/10比較)`,
        ...
        ,`
            非常にN35と関わりがが深いステージ。というのも、N35の900%のうち0~600%はこの譜面の断続的なアレンジが続くのだ。<br>
            ...
            全体の長さ　12000 (S9-4 20　は13100で少し届かない)<br>
            難易度(作者の推定)<br>
            <br>
            100% ...　★x5<br>
            200% ...　★x7<br>
    ...
    createGames("ボールころころ endless remix　★∞" , gameURL("273729141","","")+gameDesMKRS(`∞(Scratchの仕様上40000)`,`なし (新5比較)`,
        ...
        ,`
            ...
            しかもBackRoomsのように同じようなパターンの譜面しか流れてこないので結構退屈...笑　僕が今エンドレスころころ作れば少しはバリエーション増やせそう。
        `,``
        ,`[東方] 月まで届け、不死の煙`)
    ),
